...
(function () {
    ...
    window.emLocales["en-US"] = {
        ...
        "timeFilter": {
            "pastFiveMinutes": "直近5分",
            "pastTwentyMinutes": "Last 20 minutes",
            "pastThirtyMinutes": "直近30分",
            "pastHour": "直近1時間",
        ...
        "onBoarding": {
            ...
            "app-pulse-getting-started-video-name": "作業の開始",
        ...
        "landingPage": {
            ...
            "transactions-link-text": "トランザクション",
        ...
        "applicationAdmin": {
            ...
            "ok": "OK",
            "cancel": "キャンセル",
            "download-instrumentation-1": "ダウンロード",
            ...
            "download-instruction-open": "ダウンロード",
        ...
        "transactionTrend_latency_client":"応答時間",
        ...
        "transactionTrend_drillToFailures_location":"失敗",
        ...
        "applicationOverview" :  {
            ...
            "backToServiceList" : "戻る",

            "responseTimeLeftHeaderText":"PERFORMANCE",
            "responseTimeHeaderText": "応答時間",
